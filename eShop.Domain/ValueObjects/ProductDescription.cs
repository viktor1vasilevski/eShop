...
public sealed class ProductDescription : Primitives.ValueObject
{
    ...
    private ProductDescription(string value)
    {
        ...
        if (value.Length > 2500)
            throw new DomainValidationException("Product description cannot exceed 2500 characters.");

        Value = value.Trim();
    }

    public static ProductDescription Create(string value) => new ProductDescription(value);
