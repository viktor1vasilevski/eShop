...
public class ProductController(IAdminProductService _adminProductService) : BaseController
{
    ...
    [HttpGet]
    public async Task<ActionResult> Get([FromQuery] ProductAdminRequest request, CancellationToken cancellationToken)
    {
    ...
    [HttpPost]
    public async Task<ActionResult> Create([FromBody] CreateProductAdminRequest request, CancellationToken cancellationToken)
    {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult> Update([FromRoute] Guid id, [FromBody] UpdateProductAdminRequest request, CancellationToken cancellationToken)
    {
    ...
    [HttpGet("{id}/edit")]
    public async Task<ActionResult> GetProductForEdit(Guid id, CancellationToken cancellationToken)
    {
    ...
    [HttpGet("generate")]
    public async Task<ActionResult> GenerateDescription([FromQuery] GenerateAIProductDescriptionRequest request, CancellationToken cancellationToken)
    {
