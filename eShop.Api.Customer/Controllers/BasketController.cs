...
public class BasketController(IBasketCustomerService _basketCustomerService) : BaseController
{
    ...
    [HttpGet("{userId}")]
    public async Task<ActionResult<ApiResponse<BasketCustomerResponse>>> GetByUserId([FromRoute] Guid userId, CancellationToken cancellationToken)
    {
    ...
    public async Task<ActionResult<ApiResponse<BasketCustomerResponse>>> UpdateUserBasket([FromRoute] Guid userId, [FromBody] UpdateBasketCustomerRequest request, CancellationToken cancellationToken)
    {
    ...
    public async Task<ActionResult<ApiResponse<BasketCustomerResponse>>> ClearItems([FromRoute] Guid userId, CancellationToken cancellationToken)
    {
    ...
    public async Task<ActionResult<ApiResponse<BasketCustomerResponse>>> RemoveItem([FromRoute] Guid userId, [FromRoute] Guid productId, CancellationToken cancellationToken)
    {
