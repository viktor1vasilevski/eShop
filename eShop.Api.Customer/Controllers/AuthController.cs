...
public class AuthController(ICustomerAuthService _customerAuthService) : BaseController
{
    ...
    [HttpPost("login")]
    public async Task<ActionResult> Login([FromBody] UserLoginRequest request, CancellationToken cancellationToken)
    {
    ...
    [HttpPost("register")]
    public async Task<ActionResult> Register([FromBody] CustomerRegisterRequest request, CancellationToken cancellationToken)
    {
